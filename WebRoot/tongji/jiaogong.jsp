...
<script type="text/javascript">
	...
	*/}
	...
	function doSearch() {
	$('#datagrid').datagrid({
    url:'listTONGJIbyJG.action?XY_ID=<%=request.getParameter("XY_ID")%>',
    queryParams:{
	...
	function hrefsubmit(value){
	    var path = "tongji/jiaogong_detail.jsp";
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////end
	$(function(){
		...
		var actionURL='listTONGJIbyJG.action?XY_ID=<%=request.getParameter("XY_ID")%>';
...
<body class="easyui-layout">
	<div data-options="region:'west',title:'菜单',split:true"	style="width:15%;">
		<ul id="qxmenu" style="text-align:center">
			...
			<span class="tree-title">按教工查询</span>
		</ul>
	</div>
			...
			<form id="serform">
				<table class="ssk">
					<tr>
						...
						<td><select class="easyui-combobox" id="JG_serchbar"
							name="JG_ID"
							data-options="valueField:'JG_ID',textField:'JGMC',url:'<%=basePath%>listAllJIAOGONG.action'" style="width: 150px;"></td>
					</tr>
					<tr>
						<!-- 查询方式 -->
