...
<script type="text/javascript">
	...
	*/}
	...
	function doSearch() {
	$('#datagrid').datagrid({
    url:'listTONGJIbyJSdetial.action',
    queryParams:{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////end
	$(function(){
		...
		var actionURL='listTONGJIbyJSdetial.action?1=1';
		<%
		...
		%>
		<%
		if(null!=request.getParameter("JS_ID")&&!"".equals(request.getParameter("JS_ID"))){
			%>
			$('#JS_serchbar').combobox('setValue','<%=request.getParameter("JS_ID")%>');
			actionURL+='&JS_ID=<%=request.getParameter("JS_ID")%>';
			<%
		}
		%>
...
<body>
<form id="serform">
	<table style="border:solid #99BBE8; border-width:0px 0px 0px 0px; float: left;">
	<tr>
		<td colspan="10">
			教室:
			<select class="easyui-combobox"  id="JS_serchbar" name="JS_ID" data-options="valueField:'JS_ID',textField:'FJMC',url:'<%=basePath%>listAllJIAOSHI.action'">
		</td>
	</tr>
		<tr>
			<!-- 查询方式 -->
